...
BTN_BEAUTIFUL_VERSION: Final[str] = "📱 Версия-приложение"
BTN_QUICK_IN_BOT: Final[str] = "💬 Версия в чате"
...
Главное не серьёзность, а лёгкость и радость от процесса.
...
🎯 <b>Принцип:</b>
Получай удовольствие - результаты придут сами!

<i>Выбери ритуал ниже ⬇️</i>
"""

# Приветственное сообщение для WebApp
MSG_WEBAPP_READY: Final[str] = "Нажми кнопку ниже:"
